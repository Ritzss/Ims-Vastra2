...
export default function VastraDrobeIMS() {
  ...
  {filteredInventory.map((inventory) => {
    ...
    const currentSelection = inventorySelections[inventoryKey];
    ...
    return (
      <TableRow key={inventoryKey}>
        ...
        {/* Reorder Quantity */}
        <TableCell>
          {selectedSizeNode.reorderQuantity}
        </TableCell>
