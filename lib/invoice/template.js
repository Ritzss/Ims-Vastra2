...
function getStatusBadge(status) {
  ...
  if (normalized === "pending" || normalized === "processing" || normalized === "") {
    return { label: normalized ? normalized.toUpperCase() : "PENDING", className: "badge-pending" };
  }
  ...
  <div class="invoice-wrapper">
    ...
    <div class="party-grid">
      ...
      <div class="card">
        ...
        <div class="card-line">
          <span class="card-line-label">Phone:</span>${escapeHtml(COMPANY.phone)}
        </div>
        <div class="card-line">
