...
export default function invoiceTemplate(order) {
  ...
  const productRows = items
    .map((item, index) => {
      ...
      const sku = escapeHtml(safe(item.sku, `#VDP—${item.productId}`));
...
`
  ...
  <div class="footer-section">
    <div class="footer-thankyou">
      Thank you for shopping with ${escapeHtml(COMPANY.name)}!
    </div>
  ...
  <div class="site-qr">
    <img
      src="https://res.cloudinary.com/dwhn5ec09/image/upload/v1785480873/Untitled_zwjazm.svg"
      alt="Visit VastraDrobe"
      class="site-qr-img"
    />

    <div class="site-qr-text">
      Scan to visit
      <strong>VastraDrobe.com</strong>
    </div>
  </div>
